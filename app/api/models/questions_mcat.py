from sympy import symbols, latex, Eq, Integer, Add
...
class MCATQuestion2(Question):
    def __init__(self, seed, independent_var="x"):
        ...
        self.question = latex(Add(self.letter_var * self.co1 + self.co2, self.letter_var * self.co3 + self.co4, evaluate=False))
