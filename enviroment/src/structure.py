...
class Question():
    ...
    def generate_question(self, question_type):
        if question_type == "factor_1":
            self.generate_question_factor_1()
        elif question_type == "factor_2":
            self.generate_question_factor_2()
        elif question_type == "quadratic_solve":
            self.generate_question_quadratic_solve()
        elif question_type == "quote_sim":
            self.generate_question_quote_sim()
        elif question_type == "quote_solve":
            self.generate_question_quote_solve()
